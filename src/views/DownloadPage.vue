<!-- ExportPage.vue - Step 5: View & Export Selected Requirements -->
...
const selectedRequirements = computed(() => store.selectedRequirements)
...
const filteredRequirements = computed(() => {
  let filtered = [...selectedRequirements.value]
...
const handleDownload = async () => {
  ...
  try {
    await store.downloadSelectedCSV(projectId.value)
  } catch (error: any) {
  ...
  <div class="h-screen bg-gray-900 flex flex-col overflow-hidden">
      ...
      <div class="flex items-center gap-3 flex-1">
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <span class="text-blue-400 text-sm font-medium">Step 5: Download report</span>
          </div>
        </div>
      </div>
    </header>
          ...
          <div class="bg-gray-800 px-6 py-4 border-b border-gray-700 flex-shrink-0">
            <div class="flex items-center justify-between gap-4">
              ...
              <div class="flex items-center gap-6">
                <div class="text-center">
                  <p class="text-gray-400 text-xs mb-1">Total Requirements</p>
                  <p class="text-white text-xl font-bold">{{ selectedRequirements.length }}</p>
                </div>
              </div>
    ...
    >
      <div class="bg-gray-800 rounded-lg p-6 flex flex-col items-center gap-4 min-w-[300px]">
        ...
        <p class="text-white font-semibold">Preparing download...</p>
      </div>
    </div>
  </div>
</template>